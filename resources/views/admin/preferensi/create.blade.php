...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="table-responsive text-nowrap">
            <div class="row">
                <form class="needs-validation forms-sample" method="POST" action="{{ route('admin-preferensi.store') }}"
                    novalidate>
                    @csrf
                    <div class="col-lg-6 offset-2 col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-lg" name="kriteria_1" id="kriteria_1">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-lg" name="kriteria_2" id="kriteria_2">
                        ...
                        <div class="mb-5">
                            ...
                            <a href="{{ route('admin-preferensi.index') }}" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
